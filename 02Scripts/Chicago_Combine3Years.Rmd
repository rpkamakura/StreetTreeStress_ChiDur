...
```{r load data}
S23DataStreets <- read.csv("../01Data/Chicago/Raw/090623ChicagoMainSheetS23_edit.csv")
S23DataUIC  <- read.csv("../01Data/Chicago/Raw/090623UICTrees_edit.csv")
S22Data <- read.csv("../01Data/Chicago/Raw/S22ChicagoStreetTrees.csv")
S22C2C <- read.csv("../01Data/Chicago/Raw/ChicagoS22Segs_Cues2Care.csv")
S21Data <- read.csv("../01Data/Chicago/Raw/ChicagoTreeHealth_S21.csv")
S21C2C <- read.csv("../01Data/Chicago/Raw/ChicagoS21Segs_Cues2Care.csv")

#for typology and other general variables
#TreeLvlCombined <- read.csv("../../01Data/02ChicagoSampling/ProcessedData/TreeLevelDataCombined050123.csv")
...
for (t in 1:length(AllTrees)){
  ...
  if (tr %in% trees21){
    ...
    #If you have no useable HTHC data
...
write.csv(TotalTreeMat,"../01Data/Chicago/091223AllYearsComb.csv")


```

##Trees without info
* 46-01-FRUNK-089 does not have HTHC data, did not sample in 2022 or 2023 so that is what it is (maybe was removed?)
* 52-01-CECA-024 - exclude because not really on street segment
* 52-01-CECA-023 - exclude because not really on street segment
* 324-AEHI-021 - NEED TO CHECK
  - fixed, name was wrong in 2022 sheet
* 157-HIUN-015 - decided to exclude hibiscus, is correct
* 281-ACXF-024 - have 2023 data, just no 2022 health data  (1174)
* 281-ACXF-025 - have 2023 data, just no 2022 health data (1175)
* 281-ACXF-026 - have 2023 data, just no 2022 health data (1176)
* 281-ACXF-027 - have 2023 data, just no 2022 health data (1177)
* 157-CAUN-049 (should be 157-CACA-049), fixed 2021 data (figure out 157-MOAL-049) (502, 604)
* 52-01-QUBI-002 - was missing a zero (189)
* 244-SYRE-012 - messed up name in new dataset
