...
GenusFreq <- table(TreeLvlCombined_mod$Genus[!(TreeLvlCombined_mod$GenSpe %in% CommonSpp)])
GenusFreq <- GenusFreq[GenusFreq > 35]
...
#Now for the remaining common genera, group them all
...
#for remaining species, group them by size:
